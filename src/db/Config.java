...
public class Config {
    public static String LoginImagePath = "file:C:\\Users\\28529\\OneDrive\\Java实验\\FxTest\\res\\login.png";
    ...
    public static String ServerDBDomain = "ali.grayxu.cn";
    public static String LocalDBDomain = "localhost";
